"""
@original_author: (c) 2018-2019 Jorj X. McKie
@original_source: https://raw.githubusercontent.com/pymupdf/PyMuPDF-Utilities/master/doc-browser.py
A method to display a pdf Document using Tkinter
...
latex_document = 'ex.tex'
pdf_document = 'ex.pdf'

fname = current_dir+'/'+pdf_document
def open_pdf(fname):
