...
class golog(ShowBase):
    ...
    # def simpMove(self, simp, pos):
    #     simp.data['graphics'].setPos(pos)
    #     #get average Positions
    #     self.messenger.send(simp.data['_messengerName'] + ' moved',[simp.data['_messengerName'] + ' moved'])

    def simpMoverTask(self,simp,orig,task):
        t = task.time
        curve = lambda t: Point3(5*sin(t),5*sin(t),5*sin(t))
